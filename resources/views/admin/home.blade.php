                    ...
                    <div class="dashboard-widget-content">
                        ...
                        <div class="sidebar-widget">
                            ...
                            <div class="goal-wrapper">
                                ...
                                <span id="gauge-text" class="gauge-value pull-left">{{ count($projects) }}</span>
                                <span id="goal-text" class="goal-value pull-right">No Limits</span>
                            </div>
                        </div>
                    </div>
                </div>
